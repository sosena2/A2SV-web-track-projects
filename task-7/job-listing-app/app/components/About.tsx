...
const About = ({startDate, endDate, datePosted, categories, requiredSkills, location, deadline}: JobType) => {
  return (
    <div className='bg-white  rounded-lg '>
      <h3 className='font-[900] text-[24px] leading-[1.2] mb-5'>About</h3>
      ...
      <h3 className='font-[900] text-[24px] leading-[1.2] my-5'>Categories</h3>
      ...
      <h3 className='font-[900] text-[24px] leading-[1.2] my-5'>Required Skills</h3>
      <div className='flex flex-wrap gap-2'>
        {requiredSkills.map((skill, index) => (
          <span key={index} className='px-3 py-1 bg-blue-50 text-[#4640DE] rounded-full text-sm'>
            {skill}
          </span>
        ))}
      </div>
