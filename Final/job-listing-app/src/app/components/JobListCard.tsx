...
const JobListCard = ({id, logoUrl, orgName, location, title, description, categories, isBookmarked:initialBookmarked=false}: JobType) => {
   const [isBookmarked, setIsBookmarked] = useState(initialBookmarked); 
  return (
    <Link href={`/Dashboard/${id}`} passHref>
      <div className='border border-[#D6DDEB]  rounded-[30px] w-[919px] cursor-pointer hover:shadow-md transition-shadow relative'>
          ...
          <div className='flex flex-col gap-2 h-auto w-[755px]'>
            <div className='flex flex-row justify-between'> 
              ...
              <div className='h-auto '>
                ...
                <BookmarkButton eventId={id} initialBookmarked={isBookmarked} />
              </div>
